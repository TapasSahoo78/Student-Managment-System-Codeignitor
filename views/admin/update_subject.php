...
<div class="row">
  ...
  ?>
    ...
    <form role="form" method="post" action="<?php echo base_url('Add_sub_con/edit_details') ?>" class="col-xs-3">

      <div class="form-group">
      <input type="hidden" name="id" value="<?php echo $row['id'];?>">
        <label for="name">&nbsp;<i>Subject Name</i></label>
        <input type="text" class="form-control" id="name" name="subject_name" value="<?php echo $row['subj_name'];?>" >

        <label for="name">&nbsp;<i>Subject Name</i></label>
        <input type="text" class="form-control" id="name" name="is_active" value="<?php echo $row['is_active'];?>" >
      </div>
       <br>
