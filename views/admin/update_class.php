...
<div class="row">
  ...
  ?>
    ...
    <form role="form" method="post" action="<?php echo base_url('Add_class_con/edit_details') ?>" class="col-xs-3">

      <div class="form-group">
      <input type="hidden" name="id" value="<?php echo $row['id'];?>">
        <label for="name">&nbsp;<i>Class Name</i></label>
        <input type="text" class="form-control" id="name" name="class_name" value="<?php echo $row['class_name'];?>">
      </div>
       <br>
